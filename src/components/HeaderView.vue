<template>
  <div class="header">
    <nav class="navbar navbar-dark bg-dark justify-content-between">
      <a class="navbar-brand" v-on:click="home()"
        ><svg
        ...
        >
          ...
          /></svg
      ></a>
      <div class="btn btn-dark" v-on:click="Usuarios()" v-if="tipo">
      ...
      <div class="btn btn-dark d-flex align-items-center" v-on:click="buscar()">
        <a class="text-light navbar-brand">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
      ...
      <div class="btn btn-dark d-flex align-items-center" v-on:click="salir()">
        <a class="text-light navbar-brand">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
